...
return [
    ...
    | as regras de tamanho. Fique à vontade para ajustar cada uma dessas mensagens.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'O campo :attribute foi exposto em uma violação de dados. Escolha outro :attribute.',
    ],
    ...
    | atributos utilizando o formato "atributo.regra" para nomear as linhas.
    | Isso ajuda a definir uma mensagem personalizada para uma determinada 
    | regra de atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas de linguagem a seguir são usadas para trocar o marcador de 
    | atributo por algo mais amigável ao leitor, como "Endereço de E-Mail" 
    | em vez de "email". Isso simplesmente nos ajuda a criar mensagens mais
    | expressivas.
    |
    */
