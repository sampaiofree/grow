            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg" style="height: 55vh; overflow: scroll;">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="table-responsive">
                        <table id="utmTableCampanha" class="table table-sm">
                            <thead>
                                <tr>
                        ...
                        <select id="utmMediumSelect" class="form-select">
    ...
    copiarConteudoEntreElementos('campanha_total_carrinho_abandonado_', 'campanha_total_carrinho_abandonado_receber_');
        ...
        function ordenarTabela(campo) {
                ...
                linhasCampanha.sort((a, b) => {
                    const valorA = a.getAttribute(`data-${campo}`);
                    const valorB = b.getAttribute(`data-${campo}`);
                    
                    if (campo === 'data') { // Ordenação para datas
                        return new Date(valorA) - new Date(valorB);
                    } else if (campo === 'valor') { // Ordenação para valores numéricos
                        return parseFloat(valorA) - parseFloat(valorB);
                    } else { // Ordenação padrão para strings
